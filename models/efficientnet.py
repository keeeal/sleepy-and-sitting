...
def efficientnet_b0(**kwargs: Any) -> EfficientNet:
    ...
    return EfficientNet(inverted_residual_setting, 0.2, **kwargs)
...
def efficientnet_b2(**kwargs: Any) -> EfficientNet:
    ...
    return EfficientNet(inverted_residual_setting, 0.3, **kwargs)
...
def efficientnet_b4(**kwargs: Any) -> EfficientNet:
    ...
    return EfficientNet(inverted_residual_setting, 0.4, **kwargs)
